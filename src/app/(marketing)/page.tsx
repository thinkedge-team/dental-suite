...
import { mockServices, mockDoctors, mockBranches, mockInsurances, mockTestimonials, mockTechnologies, mockPromos, mockGallery } from "@/data/mock-grow";
...
export default function HomePage() {
  ...
  return (
    <div className="space-y-28 md:space-y-40 pb-32 font-sans selection:bg-primary/20">
        ...
        <div className="flex items-end justify-between mb-8 gap-4">
          ...
          <div className="flex gap-2 shrink-0">
            <button
              ...
              className="w-10 h-10 rounded-xl border border-border/70 bg-card flex items-center justify-center hover:border-primary/40 hover:text-primary transition-colors"
            >
      ...
      {/* 3. INTERACTIVE CLINICAL TRANSFORMATION SLIDER (Genuine Before-After Proof) */}
      <section className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
      ...
      {/* 4. CLINICAL STANDARDS PROTOCOL: Replaces AI Slop 3-Equal Cards with Professional Checklist */}
      <section className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
      ...
      <section className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        {lightboxIdx !== null && (() => {
          const filtered = mockGallery.filter((item) => activeFilter === 'all' || item.category === activeFilter);
