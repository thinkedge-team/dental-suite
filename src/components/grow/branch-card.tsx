...
export function BranchCard({ branch }: BranchCardProps) {
  ...
  return (
    <article className="group relative flex flex-col justify-between rounded-2xl bg-card border border-border/70 p-6 sm:p-7 shadow-xs hover:shadow-md hover:border-primary/40 transition-all duration-300 font-sans">
      <div className="space-y-5">
        ...
        <div className="flex items-start justify-between gap-3">
          <div className="space-y-1">
            ...
            <h3 className="text-lg sm:text-xl font-bold text-foreground tracking-tight group-hover:text-primary transition-colors pt-1">
              {branch.name}
            </h3>
          </div>
        </div>
